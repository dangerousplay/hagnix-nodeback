...
export const JWTKEY = config.get('JWT-Key');
export const JWTTokenExpiration = config.get('JWT-Token-Expiration');
export const JWTRTokenExpiration = config.get('JWT-RefreshToken-Expiration');
...
export const ResponseChannel = 'response';